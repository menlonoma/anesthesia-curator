...
export default function MappingTableCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MappingTable(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MappingTableCreateForm")}
      {...rest}
    >
      <TextAreaField
        label="Labels"
